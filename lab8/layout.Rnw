...
The least-squares regression line used for prediction is: $y=\Sexpr{sales.lm[[1]][[2]]}x+\Sexpr{sales.lm[[1]][[1]]}
and $r^2$ = \Sexpr{summary(sales.lm)[[9]]}
...
\indent            = \Sexpr{sales[,2][1]} - \Sexpr{sales.predict[1]}
\indent $residual$ = \Sexpr{sales[,2][1] - sales.predict[1]}

\pagebreak
\section*{Code}
<<ref.label=c('setup','A_1','A_2','A_3'),echo=TRUE,eval=FALSE,tidy=TRUE>>=
@
